...
class ChatController extends GetxController {
  ...
  // Добавление
  void addMessage(types.Message msg) {
    messages.insert(0, msg);
    update();
  }

// Загрузка из локального файла
  void loadMessagesFromFile(String filename) async {
    final response = await rootBundle.loadString(filename);
    final mess = (jsonDecode(response) as List)
  ...
  void handleSendPressed(types.PartialText msg) {
